...
export class ShowTechComponent implements OnInit {
    ...
    data: any;
    json = {
        token: localStorage.getItem('token'), user: 'admin',
    ...
    ngOnInit() {
        ...
        this.techService.getTechById({ token: localStorage.getItem('token'), user: 'admin', id: this.idTech }).then((response) => {
        ...
        this.documentoService.getTechDocs({ token: localStorage.getItem('token'), id: this.idTech, user: 'admin' }).then((response) => {
            if (response['status'] == true) {
    ...
    deleteDoc(id) {
        this.documentoService.deleteTechDoc({ token: localStorage.getItem('token'), user: 'admin', id: id, id_tecnico: this.idTech }).then((response) => {
            if (response['status'] == true) {
    ...
    renewKeygen() {
        this.techService.renewKeygen({ token: localStorage.getItem('token'), user: 'admin', id_tecnico: this.idTech }).then((response) => {
            if (response['status']) {
    ...
    hideTech() {
        this.techService.hideTech({ token: localStorage.getItem('token'), user: 'admin', id: this.idTech }).then((response) => {
            if (response['status']) {
    ...
    showTech() {
        this.techService.showTech({ token: localStorage.getItem('token'), user: 'admin', id: this.idTech }).then((response) => {
            if (response['status']) {
